        ...
        public string GenerateSubmissionReference(int reservoirid, DateTime submitteddatetime,int serviceid)
        {
            ...
            try
            {
                if (reservoirid != 0)
                {
                    ...
                    submissionreference = String.Concat(submissionreference, serviceid.ToString("01"), "_", submitteddatetime.Year, submitteddatetime.Month.ToString("MM"), submitteddatetime.Date.ToString("dd"), "_", submitteddatetime.Hour, submitteddatetime.Minute, submitteddatetime.Second);
