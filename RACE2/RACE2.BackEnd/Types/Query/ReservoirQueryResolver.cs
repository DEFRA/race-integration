...
namespace RACE2.BackEnd.Types
{
    ...
    public class ReservoirQueryResolver
    {
        ...
        public async Task<Reservoir> GetReservoirById([Service] IReservoirService _reservoirService, int id)
        {
            var result = await _reservoirService.GetReservoirById(id);
            return result;
        }

        public async Task<List<ReservoirDetailsDTO>> GetReservoirsByUserId([Service] IReservoirService _reservoirService, int id)
        {
            var result = await _reservoirService.GetReservoirsByUserId(id);
            return result;
        }

        public async Task<List<DataModel.Action>> GetActionsListByReservoirIdAndCategory([Service] IReservoirService _reservoirService, int reservoirid, int category)
        {
            return await _reservoirService.GetActionsListByReservoirIdAndCategory(reservoirid, category);
        }

        public async Task<List<SafetyMeasure>> GetSafetyMeasuresListByReservoirId([Service] IReservoirService _reservoirService, int reservoirid)
        {
            return await _reservoirService.GetSafetyMeasuresListByReservoirId(reservoirid);
        }

        public async Task<Address> GetAddressByReservoirId([Service] IReservoirService _reservoirService, int reservoirid, string operatortype)
        {
            try
            {
        ...
        public async Task<List<OperatorDTO>> GetOperatorsforReservoir([Service] IReservoirService _reservoirService, int reservoirid, string operatortype)
        {
            try
            {
        ...
        public async Task<List<ReservoirDetailsDTO>> GetReservoirsByUserEmailId([Service] IReservoirService _reservoirService, string emailId)
        {
            var result = await _reservoirService.GetReservoirsByUserEmailId(emailId);
            return result;
        }

        public async Task<List<SubmissionStatusDTO>> GetReservoirStatusByEmail([Service] IReservoirService _reservoirService, string email)
        {
            try
            {
